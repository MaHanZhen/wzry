                ...
                <div class="t clearfix">
                    ...
                    <div class="hm-detail-fun l">
								<span class="icon-like">
										<a href="${basePath }/likeArticle.html?articleId=${article.articleid}"><i></i>${article.likecount }</a>
								</span>
            ...
            <ul class="detail-floors">
                <li class="floor clearfix">
                    <div class="floorer-info l">
                        <div class="floorer-photo">
                            <c:if test="${article.picUrl == null || article.picUrl=='' }">
                                <img src="images/default.png" height="55"/>
                            </c:if>
                            <c:if test="${article.picUrl != null && article.picUrl!='' }">
                                <img src="${basePath }/${article.picUrl}" height="55"/>
                            </c:if>
                    ...
                    <div class="floor-con l">
                        <div class="floor-info clearfix">
                            <div class="floor-time l">发帖时间：<fmt:formatDate value="${article.posttime }"
                ...
                <c:forEach items="${comments }" var="comment" varStatus="status">
                    <li class="floor clearfix">
                        ...
                        <div class="floor-con l">
                            <div class="floor-info clearfix">
                                <div class="floor-time l">回贴时间：<fmt:formatDate value="${comment.commenttime }"
                                                                               pattern="yyyy-MM-dd HH:mm:ss"/></div>
                            ...
                            <div class="floor-art-ans">
                                ...
                                <div class="floor-ans">
                                    <ul>
                                        <c:forEach items="${commentReplies }" var="reply">
                                            <c:if test="${reply.commentid == comment.commentid}">
                                                <!-- 回复部分 -->
                                                <li class="clearfix">
                                                    ...
                                                    <div class="floor-ans-con l">
                                                        ...
                                                        <span class="ans-time"><fmt:formatDate
...
<div class="con">您没有登录论坛，请登录后再进行回复</div>-->
            ...
            <!-- 登录后显示评论输入框-->
            <form id="commentForm" action="${basePath }/comment.html" method="post" onsubmit="return checkComment();">
                <div class="con con-loged">
                    <div class="con-t">
                        <textarea id="content" name="commentcontent" placeholder="请在此输入您要评论的信息"></textarea>
                    </div>
                    <div class="con-b">
...
<!-- 回复弹出框 -->
<form id="replyForm" action="${basePath }/commentReply.html" method="post" onsubmit="return checkReply();">
